...
@Component({
  selector: 'vex-seleccionar-aspirantes-posgrado',
  templateUrl: './seleccionar-aspirantes-posgrado.component.html',
  styleUrls: ['./seleccionar-aspirantes-posgrado.component.scss']
})
export class SeleccionarAspirantesPosgradoComponent implements OnInit {
  ...
  async ngOnInit() {
    let res = await this.aspiranteServices.obtenerAspirantes(2);
